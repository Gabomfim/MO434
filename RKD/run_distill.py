...
def run_experiment(opts):
    ...
    best_val_rec, best_val_embeddings, best_val_labels = evaluate(student, student_normalize, loader_eval, 0, return_embeddings=True)
    ...
    for epoch in range(1, opts.epochs + 1):
        ...
        val_recall, val_embeddings, val_labels = evaluate(student, student_normalize, loader_eval, epoch, return_embeddings=True)
